        ...
        <div className="card bg-dark text-white">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              This dynamic Website application made with HTML, CSS, and
              JavaScript will allow a user to search for a movie title and get a
              list of movies to select from. Once they have selected a movie,
              they can click on it to reveal what platforms that movie is
              streaming from.
            </p>
      ...
      <div className="col">
        <div className="card bg-dark text-white">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              This is a note taking application used to write and save notes
              using Express.js. It saves and retrieves note data from a JSON
              file.
            </p>
            <a
      ...
      <div className="col">
        <div className="card bg-dark text-white">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              This allows one to quickly and easily create a README file by
              using a command-line application to generate one. This allows the
